...
#ifndef CXENSESDK_SWIFT_H
#define CXENSESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CxenseSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC9CxenseSDK16BaseEventBuilder")
...
@interface CXConversionEventBuilder (SWIFT_EXTENSION(CxenseSDK))
...
@interface CXCxense (SWIFT_EXTENSION(CxenseSDK))
...
@interface CXPageViewEventBuilder (SWIFT_EXTENSION(CxenseSDK))
...
@interface CXPerformanceEventBuilder (SWIFT_EXTENSION(CxenseSDK))
- (CXPerformanceEvent * _Nullable)build:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC9CxenseSDK11ServerError")
